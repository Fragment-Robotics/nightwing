...
#include "nightwing_data/zed_rgb_converter.hpp"
...
: Node("zed_cvt_node", options), mDefaultQoS(1)
{
  ...
  RCLCPP_INFO(get_logger(), " ZED BGRA2BGR Convert Component ");
  RCLCPP_INFO(get_logger(), "********************************");
...
RCLCPP_COMPONENTS_REGISTER_NODE(nightwing::data::ZedRgbCvtComponent)